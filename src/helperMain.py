...
def display_help_longer():
    ...
    """
    print("\n\033[1;33mQuantum Eigenvalue Transformation and Quantum Signal Processing Simulator - Detailed Help\033[0m")
    ...
    print("   Input: {'theta': 0.57}")
    print("\n3. \033[1mquantum signal processing:\033[0m")
    print("   Input: [[0.5, 1.5], 0.9] ")
    print("\n4. \033[1mquantum eigenvalue transform:\033[0m")
